...
| `EMA_FAST_LEN` | `20` | Fast EMA period. Global default; overridden per symbol in `config.py` (e.g. 50 for BTC). |
| `EMA_TREND_LEN` | `60` | Trend EMA period. Global default; overridden per symbol in `config.py` (e.g. 60 for BTC). |
